...
def WaterBox(constrain=True, flexible=True, cutoff=None, mm=None, nonbonded_method=None, filename=None, charges=True):
    """
...
def AlanineDipeptideImplicit(mm=None, flexibleConstraints=True, shake='h-bonds'):
    ...
    system = amber.readAmberSystem(prmtop_filename, mm=mm, gbmodel='OBC', shake=shake, flexibleConstraints=flexibleConstraints)
...
def AlanineDipeptideExplicit(mm=None, flexibleConstraints=True, shake='h-bonds', nonbondedCutoff=None):
    ...
    # Initialize system.
    import simtk.pyopenmm.amber.amber_file_parser as amber
    system = amber.readAmberSystem(prmtop_filename, mm=mm, nonbondedCutoff=nonbondedCutoff, nonbondedMethod='PME', shake=shake, flexibleConstraints=flexibleConstraints)
...
def LysozymeImplicit(mm=None, flexibleConstraints=True, shake='h-bonds'):
    ...
    # Initialize system.
    import simtk.pyopenmm.amber.amber_file_parser as amber
    system = amber.readAmberSystem(prmtop_filename, mm=mm, nonbondedMethod='NoCutoff', gbmodel='OBC', shake=shake, flexibleConstraints=flexibleConstraints)
...
def MethanolBox(mm=None, flexibleConstraints=True, shake='h-bonds', nonbondedCutoff=None, nonbondedMethod='CutoffPeriodic'):
    ...
    # Initialize system.
    import simtk.pyopenmm.amber.amber_file_parser as amber
    system = amber.readAmberSystem(prmtop_filename, mm=mm, nonbondedCutoff=nonbondedCutoff, nonbondedMethod=nonbondedMethod, shake=shake, flexibleConstraints=flexibleConstraints)
...
def MolecularIdealGas(mm=None, flexibleConstraints=True, shake=None, nonbondedCutoff=None, nonbondedMethod='CutoffPeriodic'):
    ...
    # Initialize fully-interacting reference system.
    import simtk.pyopenmm.amber.amber_file_parser as amber
    reference_system = amber.readAmberSystem(prmtop_filename, mm=mm, nonbondedCutoff=nonbondedCutoff, nonbondedMethod=nonbondedMethod, shake=shake, flexibleConstraints=flexibleConstraints)
